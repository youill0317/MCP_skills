...
## Active Technologies
- TypeScript targeting ES2022 on Node.js 20+ + Node.js standard library, TypeScript 5.6.3, `@types/node` 22.8.7 (002-remove-mcp-guides)
- Local filesystem only; active skills under `skills/`, planning artifacts under `specs/` (002-remove-mcp-guides)
...
## Recent Changes
- 002-remove-mcp-guides: Added TypeScript targeting ES2022 on Node.js 20+ + Node.js standard library, TypeScript 5.6.3, `@types/node` 22.8.7
